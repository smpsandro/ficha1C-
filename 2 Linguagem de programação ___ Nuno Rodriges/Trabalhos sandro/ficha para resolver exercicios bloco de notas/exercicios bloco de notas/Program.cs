...
exercicio 9
 * Descubra o maior entre 3 números fornecidos pelo utilizador.
 */
void maior3()
{ 
int num1, num2, num3;
...
Console.WriteLine("o tresceiro numero");
num3 = int.Parse(Console.ReadLine());

if ((num1 >= num2) && (num1 >= num3))
{ 
    Console.WriteLine($"o Numero {num1} e o maior");
}
else if ((num2 >= num1) && (num2 >= num3))
{
    Console.WriteLine($"o Numero {num2} e o maior");
}
else
    Console.WriteLine($"o Numero {num3} e o maior");
return;
}


/*
 Utilize os conhecimentos já adquiridos e programas já codificados para a resolução deste
exercício.
O cliente Vendas Breves S.A. solicitou-nos uma aplicação para as registadoras da sua
rede de supermercados.
Por cada compra de cliente, a registadora deverá receber do utilizador linhas para uma
venda com os seguintes dados:

Código de artigo;
Quantidade;
Preço unitário.

O utilizador pode inserir um nº de artigos indeterminado.
Termina a introdução de dados inserindo o código de artigo 0.
Se a soma dos valores da venda for superior a 50, aplica um desconto ao total de 20%.
No final deverá mostrar o total, o desconto e o total depois do IVA (23%), conforme os
exemplos a seguir
...
int codArt, quant;
float preco, total=0, desconto, totalfinal;




Console.WriteLine("introduza o codigo do artigo");
...
Console.WriteLine(total);
    if (total >= 50)
    {
        ...
        desconto = total * 0.20f;
        Console.WriteLine($"O desconto é de {desconto}");
        totalfinal = total - (total * 0.20f);

        Console.WriteLine($"O Valor a pagar já com desconto será de  {totalfinal}");
